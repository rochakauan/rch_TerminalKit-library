namespace rch_TerminalKit
{
    ...
    public static class TerminalDefaults
    {
        ...
        /// </summary>
        public static string DefaultPauseMessage { get; set; } = "Press any key to continue...";

        /// <summary>
        /// The default message shown before terminating the program.
        /// </summary>
        public static string DefaultKillMessage { get; set; } = "Closing the program...";

        /// <summary>
        /// The message shown when the user provides invalid input.
        /// </summary>
        public static string InvalidInputMessage { get; set; } = "Invalid input, try again.";
